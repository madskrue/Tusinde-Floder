...
const alleVaaben = {
    vaaben: [
        ...
        levelKrav: { },
        opgradering: 0,
        leder: null,            // "sakral", "profan", "bølgende", null
        tillaegsevne: null,
...
const alleFaerdigheder = {
    klassefaerdigheder: [
        ...
        kvalifikation: "Lærd",
        type: "aktiv",
        beskrivelse: "En gang per cyklus kan du, med din profane Leder, tegne et cirkulært segl på jorden med en diameter på 3 spænd. Når man står på dette segl, får man +1d6 til alle angrebsrul, der bruger Visdom. Seglet varer i 3 runder.",
        },
...
const alleBesvaergelser = {
    besvaergelser: [
        ...
        basis: "Evne",
        levelKrav: { },
        lederKrav: null,    // "sakral" / "profan" / null
        type: null,         // "fysisk" / "mental" / null
        effekt: null,       // "skade" / "heling" / "kontrol"
        hu: null,           // tal / null
        sejd: null,         // tal / null
        ...
        navn: "Afladning",
        beskrivelse: "Aflad en statisk puls fra din Leder to et mål indenfor 2 spænd. Gør dobbelt basisskade.",
        skole: "Natur",
        basis: "visdom",
        levelKrav: { visdom: 18 },
        lederKrav: "profan",
        ...
        navn: "Elektrisk segl",
        beskrivelse: "Tegn et segl i luften med din Leder indenfor 1 spænd. En elektrisk puls forsegles og udløses automatisk, hvis en person berører seglet. Kan også udløses på din tur for 1 Hu og række op til 1 spænd. Gør basisskade.\n\nVarer i 2 runder eller til seglet udløses.",
        skole: "Natur",
        basis: "visdom",
        levelKrav: { visdom: 27 },
        lederKrav: "profan",
